...
/* package letitbe-0.0.0 */
#ifndef VERSION_letitbe
#define VERSION_letitbe "0.0.0"
#endif /* VERSION_letitbe */
#ifndef MIN_VERSION_letitbe
#define MIN_VERSION_letitbe(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_letitbe */
...
#define CURRENT_COMPONENT_ID "letitbe-0.0.0-GAXftdqdOeIBhObSuNkykf-my-test-suite"
